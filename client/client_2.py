import socket
import pyaudio
from cryptographic.RSA import deserialize_public_key, generate_rsa_keypair, serialize_public_key
...
def client():
    ...
    print("[*] Отправка публичного ключа клиента на сервер " + serialized_client_public_key.hex())

    # Запуск приема аудио данных
    receive_audio(client_socket)
    print("[*] Запуск передачи аудио ")
